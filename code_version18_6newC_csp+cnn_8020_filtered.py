...
def load_and_preprocess_subject(subject, run_type="T"):
    ...
    target_channels = ['EEG-FC3', 'EEG-C3', 'EEG-CP3', 'EEG-FC4', 'EEG-C4', 'EEG-CP4']
...
def make_generator(n_channels=6):
...
def train_wgan_gp_for_subject(X_real_data, y_train_data, epochs=100, verbose=False, n_channels=6):
...
def train_and_evaluate_subject(subject_id, epochs_wgan=150, epochs_cnn=150):
    ...
    generator_subj, critic_subj = train_wgan_gp_for_subject(X_train_subj, y_train_subj, epochs=epochs_wgan, verbose=False, n_channels=6)
